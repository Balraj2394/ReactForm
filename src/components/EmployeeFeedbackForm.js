...
function EmployeeFeedbackForm(){
    ...
    const validationSchema=Yup.object({
        ...
        department:Yup.string().oneOf(["Web Development", "AI", "Data Science"], "Invalid department").required("Department is required"),
        rating:Yup.number()
            ...
            <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
                <Form>
                    ...
                    <div>
                        ...
                        <ErrorMessage name="department" component="div" className="error" ></ErrorMessage>
                    </div>

                    <div>
                        <label>Rating (1-5):</label>
                        <Field type="number" name="rating" className="field"/>
                        <ErrorMessage name="rating" component="div" className="error" ></ErrorMessage>
                    </div>

                    <div>
                        <label>Feedback:</label>
                        <Field type="text" name="feedback" className="field"/>
                        <ErrorMessage name="feedback" component="div" className="error" ></ErrorMessage>
                    </div>
